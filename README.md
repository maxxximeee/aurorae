...
Vous trouverez ici les documents importants relatifs à ce projet tels que l'analyse des données de différents laboratoires ainsi que de l'expérience en Python ainsi que les détails du protocole de l'expérience – simulateur auroral Terrella – et le fichier de présentation du projet.

![Expérience](Expérience.jpg)
